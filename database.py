...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        of each NEO has a collection of that NEO's close approaches, and the
        ...
        for approach in self._approaches:
            ...
            self._neos_by_designation[approach._designation].\
    ...
    def get_neo_by_designation(self, designation):
        ...
        """
        try:
            self._neos_by_designation[designation]
        except KeyError:
            return None
        else:
    ...
    def query(self, filters=()):
        ...
        for approach in self._approaches:
            ...
            filter_criteria = [filter(approach) for filter in filters]

            if not filters:
                yield approach
            elif all(filter_criteria):
                yield approach
