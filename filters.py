...
class DateFilter(AttributeFilter):
    """Sub-class of `AttributeFilter` to compare dates."""
...
class DistanceFilter(AttributeFilter):
    """Sub-class of `AttributeFilter` to compare distance."""
...
class VelocityFilter(AttributeFilter):
    """Sub-class of `AttributeFilter` to compare velocity."""
...
class DiameterFilter(AttributeFilter):
    """Sub-class of `AttributeFilter` to compare diameter."""
...
class HazardFilter(AttributeFilter):
    """Sub-class of `AttributeFilter` to compare hazard."""
...
def create_filters(date=None, start_date=None, end_date=None,
    ...
    hazard_filter = HazardFilter(operator.eq, hazardous)
    ...
    return [filter for filter in filters if filter.value is not None]
